...
return(
  <div className="Adjust-container">
    <div className="selection-div">
      ...
      {/* < video id="Exercise-vid" width="750" height="500" autoPlay={true} muted playsInline >
            < source src={exerciseArray[index].imgUrl} alt={exerciseArray[index].alt} type="video/mp4"/>
        </video> */}
